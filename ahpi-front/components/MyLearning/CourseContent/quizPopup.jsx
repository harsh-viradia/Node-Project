    ...
    <Transition as={Fragment} show>
      <Dialog as="div" className="fixed inset-0 z-[99]" onClose={() => {}}>
        <div className="flex items-end justify-center px-4 pt-4 pb-20 text-center sm:block sm:p-0">
          ...
          >
            <div className="inline-block overflow-hidden text-left align-bottom transition-all transform shadow-xl bg-white sm:my-8 sm:align-middle sm:w-[70%] rounded-lg">
              <div className="modal-body text-center overflow-auto" style={{ height: `calc(100vh - 100px)` }}>
                {children}
              </div>
            </div>
          </Transition.Child>
